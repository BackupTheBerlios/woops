...
<template:insert base="/html" template="$/template.jsp">
    ...
    <template:put  name="title" direct="true">
		<util:resource key="page.title.manageActivityDependances"/>
    </template:put>    
    ...
    <template:put  name="contents"  content="$/participant/activity/manage/manageActivityDependancesContent.jsp"/>
